<template>
    <div class="relative w-max font-sans country-select-root">
        <button @click="isOpen = !isOpen"
            ...
            <div class="flex items-center space-x-3">
                <div class="w-7 h-7 rounded-full overflow-hidden flex items-center justify-center">
                    <img v-if="selectedCountry.flag" :src="selectedCountry.flag" :alt="selectedCountry.name"
            ...
            <svg :class="{ 'rotate-180': isOpen }" class="w-5 h-5 transition-transform duration-300 ml-2" fill="none"
        ...
        <transition enter-active-class="transition ease-out duration-100"
            ...
            <ul v-if="isOpen"
                class="absolute z-10 w-full mt-1.5 bg-gray-900 rounded-xl shadow-2xl border border-gray-700 max-h-60 overflow-auto focus:outline-none">
