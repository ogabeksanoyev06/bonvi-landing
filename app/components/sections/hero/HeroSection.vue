	...
	<section id="hero" class="max-w-[1440px] mx-auto lg:p-10">
		...
		>
			...
			<main class="relative z-10 flex-grow flex items-center justify-center w-full">
				<div class="flex flex-col lg:flex-row gap-8 px-2 md:px-6 lg:gap-16 items-center justify-center w-full mx-auto mt-10 lg:mt-0">
					<div class="flex flex-col w-full lg:w-1/2 gap-4 lg:gap-6 text-center lg:text-left order-2 lg:order-1">
					...
					<div class="w-1/2 lg:w-1/2 flex justify-center items-center order-1 lg:order-2">
						<img src="/images/bonvi-logo@2x.png" width="576" height="576" alt="Bonvi Product" class="lg:w-full h-auto object-contain" />
					</div>
				</div>
			</main>

			<img class="absolute left-0 top-0 w-full h-full object-cover pointer-events-none z-0 opacity-50 lg:opacity-100" src="/images/hero-gradient-bg.png" alt="" />
		</div>
	</section>
</template>
