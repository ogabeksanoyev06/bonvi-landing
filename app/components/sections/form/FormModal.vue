		...
		<div class="relative flex flex-col gap-6 z-10 w-full overflow-hidden px-6 py-6">
			...
			<button type="button" class="absolute top-4 right-4 p-2 rounded-full bg-gray/70 hover:bg-gray/90 transition-300" @click="isOpen = false" aria-label="Close modal">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
					<path d="M6 6L18 18M18 6L6 18" stroke="#011118" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
				</svg>
			</button>
					...
					<div class="flex flex-col gap-2 w-full">
						...
						<div class="relative">
							...
							<input
								...
								type="tel"
								class="text-base !leading-130 w-full h-11 flex items-center bg-gray border border-transparent rounded-2xl pl-[84px] px-3 placeholder-[#676767] placeholder:text-base placeholder:leading-130 outline-none focus:outline-none focus:border-dark focus:bg-white transition-300"
								required
			...
			<NuxtImg src="/images/form-modal-bg.png" alt="" class="absolute left-0 top-0 right-0 bottom-0 w-full h-full z-[-1]" />
		</div>
	</Modal>
</template>
